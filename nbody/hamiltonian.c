...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "nbody.hamiltonian",
        "sources": [
            "nbody/hamiltonian.pyx"
        ]
    },
    "module_name": "nbody.hamiltonian"
}
END: Cython Metadata */
...
#define __PYX_HAVE__nbody__hamiltonian
#define __PYX_HAVE_API__nbody__hamiltonian
/* Early includes */
#include <string.h>
#include <stdio.h>
...
static void (*__pyx_f_5nbody_4body__merge_bodies)(__pyx_t_5nbody_4body_body_t *, int, int, unsigned int); /*proto*/
...
static long double __pyx_v_5nbody_11hamiltonian_G;
static long double __pyx_v_5nbody_11hamiltonian_C;
static long double __pyx_v_5nbody_11hamiltonian_Msun;
...
static long double __pyx_f_5nbody_11hamiltonian__potential(__pyx_t_5nbody_4body_body_t *, unsigned int, int); /*proto*/
...
static long double __pyx_f_5nbody_11hamiltonian__potential_1pn(__pyx_t_5nbody_4body_body_t, __pyx_t_5nbody_4body_body_t); /*proto*/
static long double __pyx_f_5nbody_11hamiltonian__potential_2pn(__pyx_t_5nbody_4body_body_t, __pyx_t_5nbody_4body_body_t); /*proto*/
static void __pyx_f_5nbody_11hamiltonian__gradient(long double *, __pyx_t_5nbody_4body_body_t, __pyx_t_5nbody_4body_body_t, int); /*proto*/
static void __pyx_f_5nbody_11hamiltonian__gradient_free_particle(long double *, __pyx_t_5nbody_4body_body_t); /*proto*/
static void __pyx_f_5nbody_11hamiltonian__gradient_0pn(long double *, __pyx_t_5nbody_4body_body_t, __pyx_t_5nbody_4body_body_t); /*proto*/
static void __pyx_f_5nbody_11hamiltonian__gradient_1pn(long double *, __pyx_t_5nbody_4body_body_t, __pyx_t_5nbody_4body_body_t); /*proto*/
static void __pyx_f_5nbody_11hamiltonian__gradient_2pn(long double *, __pyx_t_5nbody_4body_body_t, __pyx_t_5nbody_4body_body_t); /*proto*/
...
#define __Pyx_MODULE_NAME "nbody.hamiltonian"
extern int __pyx_module_is_main_nbody__hamiltonian;
int __pyx_module_is_main_nbody__hamiltonian = 0;

/* Implementation of 'nbody.hamiltonian' */
...
static long double __pyx_f_5nbody_11hamiltonian__dot(long double *__pyx_v_v1, long double *__pyx_v_v2) {
  unsigned int __pyx_v_i;
  long double __pyx_v_result;
  long double __pyx_r;
  unsigned int __pyx_t_1;

  /* "nbody/hamiltonian.pyx":24
 * cdef long double _dot(long double *v1, long double *v2) nogil:
 *     cdef unsigned int i
 *     cdef long double result = 0.0             # <<<<<<<<<<<<<<
 * 
 ...
 *     return result
 */
    __pyx_v_result = (__pyx_v_result + ((__pyx_v_v1[__pyx_v_i]) * (__pyx_v_v2[__pyx_v_i])));
  }

  /* "nbody/hamiltonian.pyx":29
 *         result += v1[i]*v2[i]
 * 
 *     return result             # <<<<<<<<<<<<<<
 * 
...
static __pyx_ctuple_766a77__long__space_double__and_long__space_double__and_long__space_double__etc __pyx_f_5nbody_11hamiltonian__hamiltonian(__pyx_t_5nbody_4body_body_t *__pyx_v_bodies, unsigned int __pyx_v_N, int __pyx_v_order) {
  unsigned int __pyx_v_i;
  long double __pyx_v_T;
  long double __pyx_v_V;
  long double __pyx_v_H;
  long double __pyx_v_mi;
  long double __pyx_v_C2;
  long double __pyx_v_C4;
  __pyx_ctuple_766a77__long__space_double__and_long__space_double__and_long__space_double__etc __pyx_r;
  unsigned int __pyx_t_1;
  unsigned int __pyx_t_2;
  unsigned int __pyx_t_3;
  long double __pyx_t_4;
  int __pyx_t_5;
  __pyx_ctuple_766a77__long__space_double__and_long__space_double__and_long__space_double__etc __pyx_t_6;

  /* "nbody/hamiltonian.pyx":38
 * 
 *     cdef unsigned int i, j, k
 ...
 *     for i in range(N):
 */
  __pyx_v_V = __pyx_f_5nbody_11hamiltonian__potential(__pyx_v_bodies, __pyx_v_N, __pyx_v_order);
 ...
 * 
 */
    __pyx_t_4 = (__pyx_v_bodies[__pyx_v_i]).mass;
    __pyx_v_mi = __pyx_t_4;

    /* "nbody/hamiltonian.pyx":53
 * 
 *         mi = bodies[i].mass
 *         T += _kinetic_energy(bodies[i])             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_t_5 = ((__pyx_v_order >= 2) != 0);
    if (__pyx_t_5) {

      /* "nbody/hamiltonian.pyx":62
 *         if (order >= 2):
 * 
 *             T += ((1./16.)*(_modulus(bodies[i].p[0],bodies[i].p[1],bodies[i].p[2])*_modulus(bodies[i].p[0],bodies[i].p[1],bodies[i].p[2])*_modulus(bodies[i].p[0],bodies[i].p[1],bodies[i].p[2]))/(mi*mi*mi*mi*mi))/(C4)             # <<<<<<<<<<<<<<
 * 
 ...
 * 
 */
  __pyx_t_6.f0 = __pyx_v_H;
  __pyx_t_6.f1 = __pyx_v_T;
  __pyx_t_6.f2 = __pyx_v_V;
  __pyx_r = __pyx_t_6;
  goto __pyx_L0;
...
static CYTHON_INLINE long double __pyx_f_5nbody_11hamiltonian__kinetic_energy(__pyx_t_5nbody_4body_body_t __pyx_v_b) {
  long double __pyx_r;
 ...
 * @cython.boundscheck(False)
 */
  __pyx_t_1 = (0.5 * __pyx_f_5nbody_11hamiltonian__modulus((__pyx_v_b.p[0]), (__pyx_v_b.p[1]), (__pyx_v_b.p[2])));
  if (unlikely(__pyx_v_b.mass == 0)) {
    #ifdef WITH_THREAD
 ...
 */
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("nbody.hamiltonian._kinetic_energy", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 1);
  __pyx_r = 0;
  __pyx_L0:;
  return __pyx_r;
}
...
static long double __pyx_f_5nbody_11hamiltonian__potential(__pyx_t_5nbody_4body_body_t *__pyx_v_bodies, unsigned int __pyx_v_N, int __pyx_v_order) {
  unsigned int __pyx_v_i;
...
static long double __pyx_f_5nbody_11hamiltonian__potential_0pn(__pyx_t_5nbody_4body_body_t __pyx_v_b1, __pyx_t_5nbody_4body_body_t __pyx_v_b2) {
 ...
 * @cython.boundscheck(False)
 */
  __pyx_r = ((((-__pyx_v_5nbody_11hamiltonian_G) * __pyx_v_b1.mass) * __pyx_v_b2.mass) / __pyx_v_r);
  goto __pyx_L0;
...
static long double __pyx_f_5nbody_11hamiltonian__potential_1pn(__pyx_t_5nbody_4body_body_t __pyx_v_b1, __pyx_t_5nbody_4body_body_t __pyx_v_b2) {
  long double __pyx_v_r;
  long double __pyx_v_V0;
  long double __pyx_v_V;
  long double __pyx_v_m1;
  long double __pyx_v_m2;
  long double __pyx_v_m1m2;
  long double *__pyx_v_normal;
  long double __pyx_v_p12;
  long double __pyx_v_C2;
  long __pyx_v_k;
  long double __pyx_r;
  long double __pyx_t_1;
 ...
 */
  __pyx_v_V = (__pyx_v_V + (((0.25 * __pyx_v_V0) * ((((-12. * __pyx_v_p12) / (__pyx_v_m1 * __pyx_v_m1)) + ((14.0 * __pyx_f_5nbody_11hamiltonian__dot(__pyx_v_b1.p, __pyx_v_b2.p)) / __pyx_v_m1m2)) + (((2.0 * __pyx_f_5nbody_11hamiltonian__dot(__pyx_v_normal, __pyx_v_b1.p)) * __pyx_f_5nbody_11hamiltonian__dot(__pyx_v_normal, __pyx_v_b2.p)) / __pyx_v_m1m2))) / __pyx_v_C2));
 ...
 *     free(normal)
 */
  __pyx_v_V = (__pyx_v_V + (((((0.5 * __pyx_v_V0) * __pyx_v_5nbody_11hamiltonian_G) * (__pyx_v_m1 + __pyx_v_m2)) / __pyx_v_r) / __pyx_v_C2));

  /* "nbody/hamiltonian.pyx":134
 *     V += (0.5*V0*G*(m1+ m2)/r)/C2 #(0.25*V0*G*(m1+ m2)/r)/C2
 * 
 *     free(normal)             # <<<<<<<<<<<<<<
 * 
...
static long double __pyx_f_5nbody_11hamiltonian__potential_2pn(__pyx_t_5nbody_4body_body_t __pyx_v_b1, __pyx_t_5nbody_4body_body_t __pyx_v_b2) {
  long double __pyx_v_r;
  long double __pyx_v_r2;
  long double __pyx_v_m1;
  long double __pyx_v_m2;
  long double __pyx_v_m1m2;
  long double __pyx_v_m1m2sq;
  long double __pyx_v_m1sq;
  long double __pyx_v_m2sq;
  long double __pyx_v_m1cu;
  long double __pyx_v_m1qu;
  long double __pyx_v_p1_p2;
  long double __pyx_v_p12;
  long double __pyx_v_p22;
  long double __pyx_v_p14;
  long double __pyx_v_V0;
  long double __pyx_v_V;
  long double *__pyx_v_normal;
  long double __pyx_v_C2;
 ...
 */
  __pyx_v_V = (__pyx_v_V + (((((1. / 8.) * __pyx_v_V0) * (((((((5. * __pyx_v_p14) / __pyx_v_m1qu) - ((((11. / 2.) * __pyx_v_p12) * __pyx_v_p22) / __pyx_v_m1m2sq)) - ((__pyx_v_p1_p2 * __pyx_v_p1_p2) / __pyx_v_m1m2sq)) + ((5. * ((__pyx_v_p12 * __pyx_f_5nbody_11hamiltonian__dot(__pyx_v_normal, __pyx_v_b2.p)) * __pyx_f_5nbody_11hamiltonian__dot(__pyx_v_normal, __pyx_v_b2.p))) / __pyx_v_m1m2sq)) - ((6. * ((__pyx_v_p1_p2 * __pyx_f_5nbody_11hamiltonian__dot(__pyx_v_normal, __pyx_v_b1.p)) * __pyx_f_5nbody_11hamiltonian__dot(__pyx_v_normal, __pyx_v_b2.p))) / __pyx_v_m1m2sq)) - ((((3. / 2.) * (__pyx_f_5nbody_11hamiltonian__dot(__pyx_v_normal, __pyx_v_b1.p) * __pyx_f_5nbody_11hamiltonian__dot(__pyx_v_normal, __pyx_v_b1.p))) * (__pyx_f_5nbody_11hamiltonian__dot(__pyx_v_normal, __pyx_v_b2.p) * __pyx_f_5nbody_11hamiltonian__dot(__pyx_v_normal, __pyx_v_b2.p))) / __pyx_v_m1m2sq))) + (((1. / 4.) * (((__pyx_v_5nbody_11hamiltonian_G * __pyx_v_5nbody_11hamiltonian_G) * __pyx_v_m1m2) / __pyx_v_r2)) * ((__pyx_v_m2 * (((10. * __pyx_v_p12) / __pyx_v_m1sq) + ((19. * __pyx_v_p22) / __pyx_v_m2sq))) - (((0.5 * (__pyx_v_m1 + __pyx_v_m2)) * ((27. * __pyx_v_p1_p2) + ((6. * __pyx_f_5nbody_11hamiltonian__dot(__pyx_v_normal, __pyx_v_b1.p)) * __pyx_f_5nbody_11hamiltonian__dot(__pyx_v_normal, __pyx_v_b2.p)))) / __pyx_v_m1m2)))) / __pyx_v_C4));
...
static void __pyx_f_5nbody_11hamiltonian__gradients(long double **__pyx_v_out, __pyx_t_5nbody_4body_body_t *__pyx_v_bodies, unsigned int __pyx_v_N, int __pyx_v_order) {
  unsigned int __pyx_v_i;
  unsigned int __pyx_v_j;
 ...
 *         for j in range(N):
 */
      ((__pyx_v_out[__pyx_v_i])[__pyx_v_k]) = (((__pyx_v_out[__pyx_v_i])[__pyx_v_k]) + (__pyx_v_tmp[__pyx_v_k]));
    }
...
static void __pyx_f_5nbody_11hamiltonian__gradient_free_particle(long double *__pyx_v_out, __pyx_t_5nbody_4body_body_t __pyx_v_b1) {
 ...
 */
  (__pyx_v_out[3]) = ((__pyx_v_b1.p[0]) / __pyx_v_b1.mass);
 ...
 * 
 */
  (__pyx_v_out[4]) = ((__pyx_v_b1.p[1]) / __pyx_v_b1.mass);
 ...
 *     return
 */
  (__pyx_v_out[5]) = ((__pyx_v_b1.p[2]) / __pyx_v_b1.mass);
...
static void __pyx_f_5nbody_11hamiltonian__gradient_0pn(long double *__pyx_v_out, __pyx_t_5nbody_4body_body_t __pyx_v_b1, __pyx_t_5nbody_4body_body_t __pyx_v_b2) {
  long double __pyx_v_dx;
  long double __pyx_v_dy;
  long double __pyx_v_dz;
  long double __pyx_v_r;
  long double __pyx_v_r3;
  long double __pyx_v_prefactor;

  /* "nbody/hamiltonian.pyx":251
 * cdef void _gradient_0pn(long double *out, body_t b1, body_t b2) nogil:
 * 
 *     cdef long double dx = b1.q[0]-b2.q[0]             # <<<<<<<<<<<<<<
 ...
 */
  __pyx_v_r3 = ((__pyx_v_r * __pyx_v_r) * __pyx_v_r);
 ...
 *     # first 3 elements are the derivative wrt to q
 */
  __pyx_v_prefactor = (((__pyx_v_5nbody_11hamiltonian_G * __pyx_v_b1.mass) * __pyx_v_b2.mass) / __pyx_v_r3);
 ...
 *     out[2] = prefactor*dz
 */
  (__pyx_v_out[0]) = (__pyx_v_prefactor * __pyx_v_dx);
 ...
 * 
 */
  (__pyx_v_out[1]) = (__pyx_v_prefactor * __pyx_v_dy);
 ...
 *     # second 3 elements are the derivative wrt p
 */
  (__pyx_v_out[2]) = (__pyx_v_prefactor * __pyx_v_dz);
...
static void __pyx_f_5nbody_11hamiltonian__gradient_1pn(long double *__pyx_v_out, __pyx_t_5nbody_4body_body_t __pyx_v_b1, __pyx_t_5nbody_4body_body_t __pyx_v_b2) {
  unsigned int __pyx_v_k;
  long double __pyx_v_r;
  long double __pyx_v_r2;
  long double __pyx_v_r3;
  long double __pyx_v_r4;
  long double *__pyx_v_dq;
  long double *__pyx_v_normal;
  long double __pyx_v_m1;
  long double __pyx_v_m2;
  long double __pyx_v_m1sq;
  ...
  long double __pyx_v_m1m2;
  long double __pyx_v_p12;
  CYTHON_UNUSED long double __pyx_v_p22;
  long double __pyx_v_C2;
  long double __pyx_v_n_p1;
  long double __pyx_v_n_p2;
  CYTHON_UNUSED long double __pyx_v_dq_p1;
  CYTHON_UNUSED long double __pyx_v_dq_p2;
  long double __pyx_v_p1_p2;
  unsigned int __pyx_t_1;
 ...
 */
  __pyx_v_n_p1 = __pyx_f_5nbody_11hamiltonian__dot(__pyx_v_b1.p, __pyx_v_normal);
 ...
 */
  __pyx_v_n_p2 = __pyx_f_5nbody_11hamiltonian__dot(__pyx_v_b2.p, __pyx_v_normal);
 ...
 */
    __pyx_t_3 = __pyx_v_k;
    (__pyx_v_out[__pyx_t_3]) = ((__pyx_v_out[__pyx_t_3]) + (((((((((-1.0 * __pyx_v_5nbody_11hamiltonian_G) * __pyx_v_5nbody_11hamiltonian_G) * __pyx_v_m1m2) * (__pyx_v_m1 + __pyx_v_m2)) * (__pyx_v_dq[__pyx_v_k])) / __pyx_v_r4) - (((((0.25 * __pyx_v_5nbody_11hamiltonian_G) * __pyx_v_m1m2) * (__pyx_v_dq[__pyx_v_k])) * ((((14.0 * __pyx_v_p1_p2) / __pyx_v_m1m2) + (((2.0 * __pyx_v_n_p1) * __pyx_v_n_p2) / (__pyx_v_m1m2 * __pyx_v_r2))) - ((12. * __pyx_v_p12) / __pyx_v_m1sq))) / __pyx_v_r3)) + ((((0.25 * __pyx_v_5nbody_11hamiltonian_G) * __pyx_v_m1m2) * (((((2.0 * (__pyx_v_b1.p[__pyx_v_k])) * __pyx_v_n_p2) / (__pyx_v_m1m2 * __pyx_v_r2)) + (((2.0 * (__pyx_v_b2.p[__pyx_v_k])) * __pyx_v_n_p1) / (__pyx_v_m1m2 * __pyx_v_r2))) - ((((4. * (__pyx_v_dq[__pyx_v_k])) * __pyx_v_n_p1) * __pyx_v_n_p2) / (__pyx_v_m1m2 * __pyx_v_r4)))) / __pyx_v_r)) / __pyx_v_C2));
 ...
 *     free(dq)
 */
    __pyx_t_4 = (__pyx_v_k + 3);
    (__pyx_v_out[__pyx_t_4]) = ((__pyx_v_out[__pyx_t_4]) + ((((((0.25 * __pyx_v_5nbody_11hamiltonian_G) * __pyx_v_m1m2) * ((((14.0 * (__pyx_v_b2.p[__pyx_v_k])) / __pyx_v_m1m2) + (((2.0 * (__pyx_v_dq[__pyx_v_k])) * __pyx_v_n_p2) / (__pyx_v_m1m2 * __pyx_v_r2))) - ((24.0 * (__pyx_v_b1.p[__pyx_v_k])) / __pyx_v_m1sq))) / __pyx_v_r) - (((0.5 * (__pyx_v_b1.p[__pyx_v_k])) * __pyx_v_p12) / __pyx_v_m1cu)) / __pyx_v_C2));
  }
...
static void __pyx_f_5nbody_11hamiltonian__gradient_2pn(long double *__pyx_v_out, __pyx_t_5nbody_4body_body_t __pyx_v_b1, __pyx_t_5nbody_4body_body_t __pyx_v_b2) {
  unsigned int __pyx_v_k;
  long double __pyx_v_r;
  long double __pyx_v_r2;
  long double __pyx_v_r3;
  long double __pyx_v_r4;
  long double __pyx_v_r5;
  long double __pyx_v_r6;
  long double *__pyx_v_dq;
  long double *__pyx_v_normal;
  long double __pyx_v_m1;
  long double __pyx_v_m2;
  ...
  long double __pyx_v_m1cu;
  long double __pyx_v_m1qu;
  long double __pyx_v_m1fi;
  double __pyx_v_m1m2;
  double __pyx_v_m1m2sq;
  long double __pyx_v_p12;
  long double __pyx_v_p22;
  long double __pyx_v_C2;
  long double __pyx_v_C4;
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "nbody.hamiltonian.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "nbody.hamiltonian.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "nbody.hamiltonian.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "nbody.hamiltonian._memoryviewslice", /*tp_name*/
...
static int __Pyx_modinit_function_export_code(void) {
  ...
  if (__Pyx_ExportFunction("_modulus", (void (*)(void))__pyx_f_5nbody_11hamiltonian__modulus, "long double (long double, long double, long double)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_dot", (void (*)(void))__pyx_f_5nbody_11hamiltonian__dot, "long double (long double *, long double *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_hamiltonian", (void (*)(void))__pyx_f_5nbody_11hamiltonian__hamiltonian, "__pyx_ctuple_766a77__long__space_double__and_long__space_double__and_long__space_double__etc (__pyx_t_5nbody_4body_body_t *, unsigned int, int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_kinetic_energy", (void (*)(void))__pyx_f_5nbody_11hamiltonian__kinetic_energy, "long double (__pyx_t_5nbody_4body_body_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_potential", (void (*)(void))__pyx_f_5nbody_11hamiltonian__potential, "long double (__pyx_t_5nbody_4body_body_t *, unsigned int, int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_potential_0pn", (void (*)(void))__pyx_f_5nbody_11hamiltonian__potential_0pn, "long double (__pyx_t_5nbody_4body_body_t, __pyx_t_5nbody_4body_body_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_potential_1pn", (void (*)(void))__pyx_f_5nbody_11hamiltonian__potential_1pn, "long double (__pyx_t_5nbody_4body_body_t, __pyx_t_5nbody_4body_body_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_potential_2pn", (void (*)(void))__pyx_f_5nbody_11hamiltonian__potential_2pn, "long double (__pyx_t_5nbody_4body_body_t, __pyx_t_5nbody_4body_body_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_gradients", (void (*)(void))__pyx_f_5nbody_11hamiltonian__gradients, "void (long double **, __pyx_t_5nbody_4body_body_t *, unsigned int, int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_gradient", (void (*)(void))__pyx_f_5nbody_11hamiltonian__gradient, "void (long double *, __pyx_t_5nbody_4body_body_t, __pyx_t_5nbody_4body_body_t, int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_gradient_free_particle", (void (*)(void))__pyx_f_5nbody_11hamiltonian__gradient_free_particle, "void (long double *, __pyx_t_5nbody_4body_body_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_gradient_0pn", (void (*)(void))__pyx_f_5nbody_11hamiltonian__gradient_0pn, "void (long double *, __pyx_t_5nbody_4body_body_t, __pyx_t_5nbody_4body_body_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_gradient_1pn", (void (*)(void))__pyx_f_5nbody_11hamiltonian__gradient_1pn, "void (long double *, __pyx_t_5nbody_4body_body_t, __pyx_t_5nbody_4body_body_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_gradient_2pn", (void (*)(void))__pyx_f_5nbody_11hamiltonian__gradient_2pn, "void (long double *, __pyx_t_5nbody_4body_body_t, __pyx_t_5nbody_4body_body_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
static int __Pyx_modinit_function_import_code(void) {
  ...
  __pyx_t_1 = PyImport_ImportModule("nbody.body"); if (!__pyx_t_1) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (__Pyx_ImportFunction(__pyx_t_1, "merger", (void (**)(void))&__pyx_f_5nbody_4body_merger, "int (__pyx_t_5nbody_4body_body_t, __pyx_t_5nbody_4body_body_t, double)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ImportFunction(__pyx_t_1, "_merge_bodies", (void (**)(void))&__pyx_f_5nbody_4body__merge_bodies, "void (__pyx_t_5nbody_4body_body_t *, int, int, unsigned int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_nbody__hamiltonian) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "nbody.hamiltonian")) {
      if (unlikely(PyDict_SetItemString(modules, "nbody.hamiltonian", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  __pyx_v_5nbody_11hamiltonian_G = 6.67e-11;

  /* "nbody/hamiltonian.pyx":15
 * # AU**3/((d**2)*solMass) = (86400 * 86400) /( 2e30 * 1.5e11 * 1.5e11)
 * 
 ...
 * #cdef long double GM = 1.32712440018e20
 */
  __pyx_v_5nbody_11hamiltonian_C = 3.0e8;

  /* "nbody/hamiltonian.pyx":16
 * 
 * cdef long double C = 3.0e8 #(3.0e8*(u.m/u.s)).to(u.AU/u.d).value
 * cdef long double Msun = 1.988e30 # (2e30*u.kg).to(u.solMass).value             # <<<<<<<<<<<<<<
 * #cdef long double GM = 1.32712440018e20
 * 
 */
  __pyx_v_5nbody_11hamiltonian_Msun = 1.988e30;
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init nbody.hamiltonian", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init nbody.hamiltonian");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
