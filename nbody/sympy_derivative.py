...
print('d0PN/dx :=',H_N.diff(x1))
print('d0PN/dpx :=',H_N.diff(px1))
...
print('d1PN/dx :=',H_1PN.diff(x1))
print('d1PN/dpx :=',H_1PN.diff(px1))
...
print('d2PN/dx :=',H_2PN.diff(x1))
print('d2PN/dpx :=',H_2PN.diff(px1))
